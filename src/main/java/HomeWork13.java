...
import java.util.stream.Collectors;
    ...
    public class HomeWork13 {
        ...
        public static void main(String[] args) throws URISyntaxException, IOException, InterruptedException {
            ...
            System.out.println("--------------------------------------");
            Optional<User> userByIdToUpdate = HomeWork13.getIdUsers(5);
            System.out.println(HomeWork13.getIdUsers(5));
            System.out.println("--------------------------------------");
        ...
        private static User newUsers() {
            User user = new User();
            user.setName("Bondarenko Bogdan");
            user.setUsername("Bobo");
            user.setEmail("bogdan_bobo@gmail.com");
            user.setPhone("+380501234567");
            user.setWebsite("Bobo");
            Address address = new Address();
            address.setStreet("Scovorodu 15");
            address.setCity("Kiev");
            address.setSuite("Apt. 950");
            address.setZipcode("00271");
            Geo geo = new Geo();
            geo.setLat(-56.101);
            geo.setLng(58.034);
            address.setGeo(geo);
            ...
            company.setCatchPhrase("All be good");
